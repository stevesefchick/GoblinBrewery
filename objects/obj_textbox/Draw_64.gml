...
//draw x
//draw_sprite_ext(ui_x,0,textbox_location_x+textbox_width-64,textbox_location_y+16,1,1,0,c_white,1);

//draw title
draw_set_font(fnt_lantern);
draw_text_scribble(textbox_location_x + (textbox_width/4),textbox_location_y+25,"[c_white][wheel]"+textbox_title);
